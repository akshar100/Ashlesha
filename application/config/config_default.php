...
|
*/
$config['encryption_key'] = 'e-yantra.org key';
...
$config['group_enabled'] = TRUE;
$config['event_enabled'] = TRUE;
$config['survey_enabled'] = FALSE;
$config['question_enabled'] = FALSE;

$config['post_enabled'] = TRUE;
$config['post_sector_enabled'] = FALSE; 

$config['notifications_enabled'] = TRUE; 

$config['ui_test_enabled'] = FALSE; 
$config['push_notifications_enabled'] = FALSE;
$config['supported_roles'] = 'user|administrator'; //This is besides user and administrator roles
