YUI.add('babe', function (Y) {
    ...
    var AdminView = Y.Base.create('adminview', Y.View, [], {
    	containerTemplate:'<div/>',
    	showStats:function(){
    		var c = this.get('container');
    		this.get('container').one("li.stats").addClass('active');
   ...
   var QuestionCreationView = Y.Base.create('searchboxview', Y.View, [], {
    ...
    requires: ['dd','charts','router', 'autocomplete', 'autocomplete-highlighters', 'autocomplete-filters', 'datasource-get', 'datatype-date', 'app-base', 'app-transitions', 'node', 'event', 'json', 'cache', 'model', 'model-list', 'querystring-stringify-simple', 'view', 'querystring-stringify-simple', 'io-upload-iframe', 'io-form', 'io-base', 'sortable']
});